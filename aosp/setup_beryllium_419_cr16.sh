...
git clone https://github.com/duckyduckG/android_device_xiaomi_beryllium_419.git -b lineage-22.2-CR-16 device/xiaomi/beryllium
# Device tree - sdm845-common
git clone https://github.com/duckyduckG/android_device_xiaomi_sdm845-common_419.git -b lineage-22.2-CR-16 device/xiaomi/sdm845-common
...
git clone https://github.com/duckyduckG/android_vendor_xiaomi_sdm845-common_419.git -b lineage-22.2-CR-16 vendor/xiaomi/sdm845-common
...
# Sepolicy
git clone https://github.com/duckyduckG/android_device_crdroid_sepolicy.git -b 16.0 device/lineage/sepolicy
